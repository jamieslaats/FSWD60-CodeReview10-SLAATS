...
<head>
	...
	<title>Action Create Genre - CF Public Library</title>
...
if($_POST) {
 ...
 if($connect->query($sql) === TRUE) {
   ...
   echo "<a href='../creategenres.php'><button class='btn btn-default' type='button'>Create Another Record</button></a>";
