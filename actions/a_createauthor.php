...
<head>
	...
	<title>Action Create Author - CF Public Library</title>
	...
	<div class="container">
		...
		<div class="contentconfirmed">
			...
			if($_POST) {
			 ...
			 $sql = "INSERT INTO authors (Name, Surname, MediaFocus) VALUES ('$fname', '$lname', '$mediafocus')";
			 if($connect->query($sql) === TRUE) {
			   echo "<p>New Record Successfully Created</p>";
			   echo "<a href='../createauthor.php'><button type='button'>Create Another Record</button></a>   ";
			   echo "<a href='../indexcfpublib.php'><button type='button'>Homepage</button></a>";
			 } else {
