...
<head>
	...
	<title>Action Create Publisher - CF Public Library</title>
...
<body>
	<div class="container">
		...
		<div >
			<h3>CREATED PUBLISHER CONTENT</h3>
		</div>
...
if($_POST) {
 ...
 $sql = "INSERT INTO publishers (Name, Address, PostCode, City, Country, Size) VALUES ('$pubname', '$pubaddress', '$pubpostcode', '$pubcity', '$pubcountry', '$pubsize')";
 if($connect->query($sql) === TRUE) {
   echo "<p>New Record Successfully Created</p>";
   echo "<a href='../createpublisher.php'><button class='btn btn-default' type='button'>Create Another Record</button></a>";
