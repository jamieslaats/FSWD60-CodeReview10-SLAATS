	...
	<div class="container">
		...
		<div class="">
			...
			<div>
				...
				if($_GET['Genres_ID']) {
					$genresid = $_GET['Genres_ID'];

					$sql = "SELECT * FROM genres WHERE Genres_ID = {$genresid}";
            ...
            <form id="mediainputform" method="POST">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <label id="labellettering">Genre Name</label>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="GenreName" value="<?php echo $data['GenreName'] ?>">
                    </div>
                </div>
                <div class="row">
                    <div  id="labelletteringediting" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <button  id="updatebtn" class="btn btn-default" type="submit">Update Genre</button>
                    </div>
                </div>
            </form>
            ...
            if($_POST) {
                ...
                $sql = "UPDATE genres SET GenreName = '$genrename' WHERE Genres_ID = {$genresid}";
                if($connect->query($sql) === TRUE) {
                    echo "<p>Successfully Updated</p>";
                    echo "<a href='viewgenres.php?Genres_ID=".$genresid."'><button  class='btn btn-default' type='button'>Back to View Genres</button></a>";
                } else {
